...
app = FastAPI(
    ...
    description="Ping Manager is responsible for managing Ping devices connected to AirOS.",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ping Service for Airdroper AirOS")
