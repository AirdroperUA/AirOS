const menus = [
  {
    ...
    text: 'Update flight controller firmware, select the active autopilot,'
      + ' and start/stop ArduPilot (if using CORE or SITL).',
  },
  {
  ...
  },
  {
    ...
    advanced: true,
    text: 'List all available services found in AirOS serving http interfaces, and their'
  ...
  },
  {
    ...
    advanced: false,
    text: 'Manage AirOS versions and update to the latest available.',
  },
  {
    title: 'File Browser',
    icon: 'mdi-file-tree',
    ...
    advanced: true,
    text: 'Browse all the files in AirOS. Useful for fetching logs,'
  ...
  },
  {
    ...
    text: 'Allow browsing the Telemetry (.tlog) and Binary (.bin) logs generated by your vehicle. Bin logs are'
      + ' currently only supported for CORE boards.',
  },
  {
